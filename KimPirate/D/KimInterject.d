...
INTERJECT_COPY_TRANS THUMB 6 kimthumb2
  == KIMJ   IF ~InParty("KIM")~ THEN 
  @226
  == THUMB   IF ~InParty("KIM")~ THEN 
  @227
...
INTERJECT_COPY_TRANS Illasera 0 KimMeetsIllasera
==KimJ IF~InParty("Kim")  ~THEN @360
==Illasera IF~InParty("Kim") ~THEN @361
==KimJ IF~InParty("Kim")  ~THEN @362
==KimJ IF~InParty("Kim") Global("KimRomanceActive","GLOBAL",2)~THEN @365
==Illasera IF~InParty("Kim") !Global("KimRomanceActive","GLOBAL",2) ~THEN @363
==Illasera IF~InParty("Kim") Global("KimRomanceActive","GLOBAL",2) ~THEN @366
==Illasera IF~InParty("Kim")  ~THEN @364
END
